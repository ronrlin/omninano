            ...
            <div class='row' id='portfolio-filter'>
              <div class='col-sm-12'>
                <ul class='nav nav-pills'>
                  ...
                  <li><a data-filter=".portfolio-filter-intro-nanoscale" href="#">Awards</a></li>
                  <li><a data-filter=".portfolio-filter-investigating-nanoscale" href="#">Honors</a></li>
                </ul>
              </div>
            </div>
              ...
              <div class='col-sm-4 portfolio-box portfolio-filter-intro-nanoscale portfolio-item'>
                <a href="#">
                  <div class='image-link'>
                    ...
                    <img class="img-responsive img-rounded center-block" alt="Patrick Soon-Shiong Awards" width="360" height="235" src="assets/images/misc/patrick+marco.jpg" />
                  </div>
                  <h3 class='title'>Los Angeles Business Journal Award</h3>
                  <p class='category'>Finalist</p>
                </a>
              </div>
            </a>
            </div>
