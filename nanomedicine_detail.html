            ...
            <div class='row'>
              <div class='col-sm-12'>
                ...
                <ol class='breadcrumb'>
                  ...
                  <li class='active'>Nanomedicine</li>
                </ol>
                <div class='directional'>
                  <a class='has-tooltip left' data-placement='right' data-title='Previous project' href='nanomaterials_detail.html'>
                    <i class='fa-icon-chevron-left'></i>
                  </a>
                  <a class='has-tooltip right' data-placement='left' data-title='Next project' href='nanoelectronics_detail.html'>
          ...
          <div class='container'>
            <div class='row'>
              <div class='col-md-push-9 col-sm-push-8 col-sm-4 col-md-3'>
                <nav class='sidebar sidebar-fixed'>
                  ...
                  <div class='sidebar-collapse collapse'>
                    ...
                    <div class='box'>
                      <h3 class='title'>Key concepts</h3>
                      <ul class='list-unstyled list-padded'>
                        <li>
                          <i class='fa-icon-ok text-contrast fa-icon-fixed-width'></i>
                    ...
                    <div class='box'><a class="btn btn-contrast btn-bordered btn-block" href="#">Explore the full course</a></div>
                  </div>
                </nav>
              </div>
              <div class='col-md-pull-3 col-sm-pull-4 col-sm-8 col-md-9'>
                <div class='row'>
                  <div class='col-sm-12'>
                    <h2 class='no-mg-t'>Nanomedicine</h2>
                    <p class='lead'>
                      You might notice a pattern.  Our state-of-the-art understanding of natural phenomenon is often limited to understand the "average" properties of a collection of molecules or atoms, and taking advantage of that.  
                    </p>

                    <p class='lead lead-sm'>
                      In medicine, this approach means that we often can only brutishly interfere in the activities of organs and molecular systems.  For example, medicines are often delivered nonspecifically to many parts of the body, where they might cause unintended consequences interacting with other molecular systems.  Surgeries often involve a scalpel, meaning that tissues are cut and torn, with millions of molecules and material displaced as a result.
                    </p>

                    <p class='lead lead-sm'>
                      Whether medicine is overly invasive or generally unspecific in its administration, nanomedicine will involve introducing finer precision into how physicians diagnose maladies and intervene to resolve them.  
                    </p>
