            ...
            <div class='row'>
              <div class='col-sm-12'>
                ...
                <ol class='breadcrumb'>
                  ...
                  <li class='active'>Nanomaterials</li>
                </ol>
                <div class='directional'>
                  <a class='has-tooltip left' data-placement='right' data-title='Previous project' href='nanoscale_detail.html'>
                    <i class='fa-icon-chevron-left'></i>
                  </a>
                  <a class='has-tooltip right' data-placement='left' data-title='Next project' href='nanomedicine_detail.html'>
          ...
          <div class='container'>
            <div class='row'>
              ...
              <div class='col-md-pull-3 col-sm-pull-4 col-sm-8 col-md-9'>
                <div class='row'>
                  <div class='col-sm-12'>
                    <h2 class='no-mg-t'>Nanomaterials</h2>
                    <p class='lead'>
                    ...
                    <p class='lead lead-sm'>
                      Mastery of materials has usually employed "top-down" approaches to creating materials.  This means that many many atoms might be brought together and melted.  The resulting product is often a material that is actually "disordered".  Ever since the birth of solid state physics, materials have been described in terms of average material parameters.
                    </p>

                    <p class='lead lead-sm'>
                      This approach is no longer adequate for confronting the challenges of today!
                    </p>
