                  ...
                  <div class='row'>
                    <div class='col-sm-3'>
                      <a href='blog_single_post.html'>
                        <img class="img-responsive center-block img-rounded-half" alt="Cras tempus ligula a tempor adipiscing" width="189" height="129" src="assets/images/misc/patrick+marco.jpg" />
                      </a>
                    </div>
                    <div class='col-sm-9'>
                      <p>The Los Angeles Business Journal is honored to present the annual Patrick Soon-Shiong Innovation Awards for 2014, including Omni Nano for its innovative approach to disseminating nanotechnology education and educational resources.</p>
                      <a target="_blank" class='btn btn-contrast btn-bordered btn-xs' href='http://www.cbjonline.com/a2labj/supplements/PSS-Innovation-Awards_20141124.pdf'>Read more</a>
                    </div>
                  </div>
                  <hr class='hr-half'>
                </div>
