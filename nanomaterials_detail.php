            ...
            <div class='row'>
              <div class='col-sm-12'>
                ...
                <div class='directional'>
                  <a class='has-tooltip left' data-placement='right' data-title='Previous project' href='nanoscale_detail.php'>
                    <i class='fa-icon-chevron-left'></i>
                  </a>
                  <a class='has-tooltip right' data-placement='left' data-title='Next project' href='nanomedicine_detail.php'>
