          ...
          <div class='container'>
            <div class='row'>
              <div class='col-sm-12'>
                <h1 class='title'>
                  About us
                  <small>Scientists and Educators</small>
                </h1>
              </div>
            </div>
          </div>
              ...
              <div class='col-sm-12'>
                ...
                <div class='row portfolio-boxes'>
                  <div class='col-sm-12 portfolio-box'>
                    <img src="assets/images/misc/nanotechnology-applications.jpg">
                  </div>
                </div>
                ...
                <div class='profile-boxes'>
                  <div class='row'>
                    <div class='col-sm-6 profile-box'>
                      <div class='row'>
                        <div class='col-sm-4'>
                          <a class='image-link' data-lightbox data-lightbox-gallery='team' href='assets/images/misc/marco.jpg' title='David Doe'>
                            <i class='fa-icon-envelope-alt'></i>
                            <img alt="Dr. Marco Curreli" width="165" height="165" src="assets/images/misc/marco.jpg" />
                          </a>
                        </div>
                        <div class='col-sm-8'>
                          ...
                          <div class='links'>
                            ...
                            <a class='btn btn-medium-light btn-sm btn-circle' href='https://plus.google.com/109743992733691765450/posts'>
                    ...
                    <div class='col-sm-6 profile-box'>
                      <div class='row'>
                        <div class='col-sm-4'>
                          <a class='image-link' data-lightbox data-lightbox-gallery='team' href='assets/images/misc/gina.jpg' title='Gina Napolitano'>
                            <i class='fa-icon-heart-empty'></i>
                            <img alt="Gina Napolitano" width="165" height="165" src="assets/images/misc/gina.jpg" />
                          </a>
                        </div>
                        <div class='col-sm-8'>
